...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Montserrat:900|Open+Sans:600|Lato" rel="stylesheet">
  ...
  <main role="main">
    ...
    <div class="jumbotron">
      ...
      <div class="container" style="position: relative">
        ...
        <p>
          <hn>The following Privacy Policy applies to liyasinternational.com</hn>
        </p>

        <p>
          <hw>Privacy Policy</hw>
        </p>
    <div class="bread">
            <a href="/liyasupdated/index-temp">Home</a> / <span>Terms & Conditions</span>
    </div>
    ...
    <div class="container">
      ...
      <div id='ppBody'>
        ...
        <div class='innerText'>We collect information from you when you place an order, subscribe to a newsletter, respond to a survey, fill out a form or enter information on our site.</div><br>Provide us with feedback on our products or services <span id='infoUs'></span><br>
        <div
          class='grayText'><strong>How do we use your information? </strong></div><br />
      ...
      <div
        class='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> To improve our website in order to better serve you.</div>
    ...
    <div class='innerText'>If you turn cookies off, Some of the features that make your site experience more efficient may not function properly.It won't affect the user's experience that make your site experience more efficient and may not function properly.</div><br>
    <span
      id='trDi'></span><br>
      ...
      <div
        ...
        <div class='innerText'>admin@osetion.com and we will promptly remove you from <strong>ALL</strong> correspondence.</div><br><span id='ourCon'></span><br>


    <div class="footer">
            <div class='blueText blueText1'><strong>Contact Us</strong></div><br />
        ...
        <div class='innerText'><a style="color:black;" href="https://www.liyasinterantional.com">liyasinterantional.com</a></div>
        <div class='innerText'>Head Office, Ground floor, 
        <div class='innerText'>Sri Mantame Complex, Mudipu, Mangalore-574153</div>
        <div class='innerText'>liyasinternationalgd@gmail.com</div>
        <div class='innerText'>6366378967</div>
        <!-- <div class='innerText'><br>Last Edited on 2018-03-28</div> -->
    </div>
        </div>
